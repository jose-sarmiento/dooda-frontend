...
const ViewHotel = () => {
	...
	return (
		...
		<div className="hotel">
			<Link to="/p/hotels" className="btn btn--back">Go Back</Link>
			<div className="hotel-header">
				...
				<div className="d-flex flex-between">
					<div className="hotel-header__left">
						...
						<span className="hotel__location-icon"><FaMapMarkerAlt/></span>5k killometers away</h5>
					</div>
					<div className="hotel-header__right">
						<button className="btn btn--primary btn--small hotel-header__book-now" onClick={handleModalOpen}>Book now</button>
			...
			<div className="hotel__details">
				<div className="hotel__description">
					...
					<p className="hotel__paragraph">Lorem, ipsum dolor, sit amet consectetur adipisicing elit. Id tempore error quod, rem saepe aspernatur excepturi aperiam sequi beatae nesciunt delectus quasi? Quos enim culpa consequuntur, cupiditate laudantium necessitatibus fugiat, odit adipisci nulla iste excepturi magni veniam officiis aspernatur facere!</p>
					<p className="hotel__paragraph">In doloribus, pariatur, harum vero voluptates, dolorem placeat iste totam officia earum eius, alias nemo accusamus modi et obcaecati magnam ratione esse veritatis. Laborum iusto, amet. Amet esse quod, quae, ad suscipit dolorum illum quos nisi consequuntur delectus, ut deserunt saepe, dolorem obcaecati porro eius accusamus hic laudantium dolores placeat sunt aliquid. Officiis, optio, inventore. Aliquid iure vero ea suscipit, dolore voluptates dolorem odio officiis minus animi, perferendis deserunt porro assumenda nisi!</p>
